...
Runs ts lint on typescript files within `src`.

### `npm run tsc`

Runs ts compiler on typescript files within `src` but without emitting outputs.

### `npm run tsc:watch`

Runs ts compiler in watch mode.

### `npm run pretest`

Runs both ts lint and ts compiler.
